...
## donesn't work :( CASC_Data_explainer <- read_excel("G:/.shortcut-targets-by-id/1eHXdJvNMq46tBKURFTeViKWGdSBhWsL_/Data/CASC_Data_Explainer_for_R_manipulation.xlsx")
```
