...
# load libraries
  ...
  wi_fish_dat <- read_csv_arrow("E:/.shortcut-targets-by-id/1eHXdJvNMq46tBKURFTeViKWGdSBhWsL_/Data/WI_Data/wi_raw_disaggregated_data/wdnr_inland_fish_data.csv") # add arg as_data_frame = F to load without the collected data.frame
