...
EF_Catch_LMB_SMB <- read_csv("~/CASC/CASC_Fish_Abundance/Data_Summaries/MN/ELECTROFISHING_CATCH_LMB_SMB.csv")

EF_Effort_LMB_SMB <- read_csv("~/CASC/CASC_Fish_Abundance/Data_Summaries/MN/ELECTROFISHING_EFFORT.csv") #some non bass too
