...
```{r}
WI_Fish_Data <- read_csv("Data_and_Scripts/Data/Data_Summaries/WI/wdnr_inland_fish_data.csv") #this is a very large file, and we need a way to load it in better without crashing R
...
WI_Lakes <- WI_Fish_Dat_lakes %>%
  ...
  mutate(Lake_ID_Type = "WBIC")%>% #useful when combinging with other states data
