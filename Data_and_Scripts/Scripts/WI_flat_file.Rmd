...
setnames(get(gsub(".csv","", WI_files_list)[i]), colnames(get(gsub(".csv","", WI_files_list)[i])), names[!str_detect(newname,"unique_row_key")] [match(names(get(gsub(".csv","", WI_files_list)[i])),names[!str_detect(newname,"unique_row_key"),oldname]), newname] )

#confirm import of files:  
print(paste(gsub(".csv","", WI_files_list)[i] ,"added to workspace" ))  
