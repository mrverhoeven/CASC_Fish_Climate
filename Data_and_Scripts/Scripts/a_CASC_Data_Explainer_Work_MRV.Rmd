...
#To-do: 
1. Can I add the suffixes to these field names in a file specific way? This would avoid the new data added with multiple [state] suddenly adding suffixes to all and breaking everyone else's code code.
