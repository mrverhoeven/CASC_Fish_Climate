...
# No theses data do not include seemingly proper zeros. We'll reach out to the IA folks to get a new dataset that gives us all the CPUEs
...
ia_fishlengths[ , length(unique(lake_id,lake_name.1,date_clean)), survey_id ][V1 > 1]
...
ia_fishlengths[ , .N , .(site_id.1, sampling_method, survey_id, total_effort_1) ]
