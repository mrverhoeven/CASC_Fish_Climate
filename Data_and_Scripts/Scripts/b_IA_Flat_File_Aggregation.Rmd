...
###########Denver Left off right here on 9/11 at 3:30pm#####################
#before I left I updated the list of columns to what they should be
#still need to make centroid columsns and upload spaical data
...
check <- ia_fishobs %>% 
  distinct(lake_name_1, STATE_ID, NHDHR_ID, lat_unspec, lon_unspec, LAT, LON) %>% 
  mutate(diff_lat = abs(lat_unspec - LAT),
         diff_lon = abs(lon_unspec - LON))
#they this works pretty darn well! - lucky the names align between msu and iowa
