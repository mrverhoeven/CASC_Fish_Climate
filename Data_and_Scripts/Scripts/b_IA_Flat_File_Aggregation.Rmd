...
gear_corrections <- fread(file = "Data_and_Scripts/Data/input/IA_gear_notes- revisions.csv")
...
names(ia_fishobs)      
   # implement Jack's flags and deletions
    notes_corrections <- fread(file = "Data_and_Scripts/Data/input/IA_comments_notes_revisions.csv")
...
ia_fishobs[ , .N , species_1]

#do this a different way -- this way takes ~ 8 hours!
# ia_fishobs[ , species_1 := make_clean_names(species_1) ,]
# ia_fishobs[ , species_1 := gsub("\\_\\d+$", "",species_1) ,]


#Exclude rivers and streams
ia_fishobs[ ,.N , waterbody_type]

ia_fishobs <- ia_fishobs[!(waterbody_type %in% c("Trout Stream", "River"))]
