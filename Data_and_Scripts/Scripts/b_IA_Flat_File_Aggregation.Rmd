...
#now total_effort_idents exist, but the total efforts within are actual sub_efforts
...
#see here, these efforts belong to a sub_effort:
...
ia_fishobs[ , length(unique(sub_effort_ident)) , .(total_effort_ident)  ]
tot_eff_1 <- ia_fishobs[ , .N ,
                         .(total_effort_ident,sub_effort_ident,sub_effort_1,sub_effort_2, sub_effort_nothing_caught)  ][ ,
                                                                                                                          .("total_eff_1" = sum(sub_effort_1),
                                                                                                                               "total_eff_2" = sum(sub_effort_2),
                                                                                                                               "total_eff_nc" = all(sub_effort_nothing_caught)) ,.(total_effort_ident)]
...
a <- ia_fishobs[total_effort_nothing_caught == T]
