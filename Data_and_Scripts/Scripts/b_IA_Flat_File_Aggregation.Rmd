...
ia_fishlengths[ , .N , .(site_id.1, sampling_method, survey_id, total_effort_1) ] # and we seem to have ONE effort value for each of these! What a miracle!
  ...
  ia_fishlengths[ , .N , .(total_effort_ident, total_effort_1, distance, sampling_method, total_effort_1_units) ]
  ...
  ia_fishlengths[ , .N , .(total_effort_ident, total_effort_1, total_effort_1_units, total_effort_2, total_effort_2_units, sampling_method) ]
...
cols <- as.character(expression(
    state, county, lake_id, lake_name.1, date_clean, date.1, survey_id,
    total_effort_ident, total_effort_1, total_effort_1_units, total_effort_2, total_effort_2_units, sampling_method,
