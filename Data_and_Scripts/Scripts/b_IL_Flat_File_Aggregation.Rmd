...
#Data Review
#this code was used as exploration in several iterations of the ag process 
```{r}
...
il_data.prep.trail <- il_data.prep %>% 
  select(-flag) %>% 
  left_join(length_weight_flag_2, relationship = "many-to-one") %>% 
  select(survey_effort_id,
         survey_effort,
         species.1,
         weight.1,
