...
il_data %>% 
  ...
  select(lake_id, total_effort_ident, total_survey_nothing_caught, sub_survey_nothing_caught) %>% 
  print(n = nrow(.))
...
il_data %>% 
  ...
  distinct(total_effort_ident, sub_effort_ident, net_id, total_effort_ident, sub_effort_1, total_effort_1,  no_target, target_species)
