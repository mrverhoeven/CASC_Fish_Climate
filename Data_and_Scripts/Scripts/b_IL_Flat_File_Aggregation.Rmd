...
il_data_merged <- left_join(survey.effort, il_catch_age_effort_17Jan22, by = c("lake_id",
                                                                        "year", 
                                                                        "date.1", 
                                                                        "sampling_method", 
                                                                        "gear_data_notes.1",
...
no_matches <- anti_join(survey.effort, il_catch_age_effort_17Jan22, by = c("lake_id",
                                                                              "year", 
                                                                              "date.1", 
                                                                              "sampling_method", 
                                                                              "gear_data_notes.1",
...
no_fish <- right_join(il_effort_17Jan22, no_matches, by = c("lake_id",
                                                                              "year", 
                                                                              "date.1", 
                                                                              "sampling_method", 
                                                                              "gear_data_notes.1",
...
effort.check <- il_data %>% 
  distinct(lake_id, year, date.1, sampling_method, total_effort_2, total_effort_1, .keep_all = T) %>% 
  select(lake_id, lake_name.1, year, date.1, sampling_method, total_effort_2, total_effort_1, survey_effort)
...
excluded <- anti_join(il_catch_age_effort_17Jan22, il_data, by = c("lake_id",
                                                                   "year", 
                                                                   "date.1", 
                                                                   "sampling_method", 
                                                                   "gear_data_notes.1",
