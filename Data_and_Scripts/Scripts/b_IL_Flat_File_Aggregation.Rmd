...
#the effort file is not needed because the effort for each survey is already in the catch file
...
survey.effort %>% 
  filter(survey_id %in% c("Survey_880", "Survey_1324", "Survey_525"))
...
#need to clean up column naming (underscores/periods)
