...
#will need to clean up lake names and county names for merge (need Matthew Linn's help with this)
  # instead have worked out kinks with lake ID and will use that instead for merge
...
in_glacial_lakes_standard_merge <- in_glaciallakes_fish_6Oct2021_ID %>%
  full_join(in_glaciallakes_effort_6Oct2021_ID, by = c("lake_id", "sampling_method", "year"))
# NOT SURE THIS IS A GOOD ENOUGH KEY, SUS IT OUT
...
## can delete if above works ____________________________________________________________
