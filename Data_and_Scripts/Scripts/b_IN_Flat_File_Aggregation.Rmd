...
try to get NHD IDs
```{r}
# IN_DNR_nhdhr_xwalk <- readRDS("~/CASC/CASC_Fish_Climate/Data_and_Scripts/Scripts/Crosswalks/IN_DNR_nhdhr_xwalk.rds")

in_lake_id_list_good <- in_lake_id_list_1Dec2023_fixed %>%
  mutate(county = str_to_title(county))%>%
  mutate(Lake_County_Name = paste(lake_name.1, county, sep = "_"))%>%
  left_join(IN_DNR_nhdhr_xwalk, by = "Lake_County_Name")


# okay this is going to be a mess... will revisit another day
```
...
rm(in_glaciallakes_effort_6Oct2021, in_effort_prob_list, in_glaciallakes_effort_6Oct2021_2)

 
# quick export of list and which do have working NHD IDs
#write_csv(in_glaciallakes_effort_6Oct2021_ID, "IN_glaciallakes_NHD_attempt.csv")
```
...
- note, at one point, the dates were not matching, and we were losting 10,051 fish obs and 31 surveys. However, this seems to be resolved after making the dates IDates.
