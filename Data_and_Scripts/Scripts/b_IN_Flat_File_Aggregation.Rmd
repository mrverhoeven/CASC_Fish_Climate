...
anti.age <- anti_join(in_reservoir_age_fish_16Aug2022_merge,
  ...
  select(survey_id,
         ...
         age_id,
         date_1)
#we have 6007 aged fish after the effort merge, 2991 matched with fish already in res surveys. Thus, we should get 3016 fish that do not match and are "extra fish". These will not be for abundance surveys but could be useful for ALKs
