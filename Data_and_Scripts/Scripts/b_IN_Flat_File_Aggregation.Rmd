...
```{r}
in_glaciallakes <- bind_rows(in_glaciallakes_standard_tidy, in_glaciallakes_targeted_inner_join_tidy)
```
...
Bind IN Glacial Lakes and IN Reservoirs together
```{r}
#ASK DENVER ABOUT AGED FISH RESERVOIRS

in_ALL <- bind_rows(in_glaciallakes, in_reservoir_data_noage_tidy)
