...
mi_cine_merge <- merge(mi_statustrends_effort_16Mar2021,mi_statustrends_catchlengthclass_03July2023, by = c( "lake_name.1", "survey_id", "sampling_method_abbrev"), all = T, suffixes = c("_effort", "_catch"))

rbindlist(list(mi_statustrends_effort_16Mar2021,mi_statustrends_catchlengthclass_03July2023))


mi_statustrends_catchlengthclass_03July2023[mi_statustrends_effort_16Mar2021,
                                            on = .(lake_name.1 = lake_name.1,
                                                   survey_id = survey_id,
...
length(colnames(mi_statustrends_effort_16Mar2021))

mi_ce_merge[ , unique(sampling_method_abbrev) , file_number_effort] #full coverage of effort for all catch data
mi_ce_merge[ , .N , .(file_number_catch,sampling_method_abbrev)]
