...
mi_catch_eff_merge %>% 
  group_by(is.na(age), is.na(total_effort_1_effort), is.na(effort_ident)) %>% 
  count()
#now we can see that aged fish have an NA effot ident becuase they don't have effort, there is also one odd survey that doesn't have effor that also does not retain an effort ident
