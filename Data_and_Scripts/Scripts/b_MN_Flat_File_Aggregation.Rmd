...
wae_gn_records <- flatfish[ species.1 == "WAE" & 
                              str_detect(sampling_method, "gill nets"),,]

wae_gn_records[ , .N , .( age_dat = !is.na(age), length_dat = !is.na(length.1))]

wae_gn_records[ , .N , .(year = year(date_clean), age = !is.na(age), length = !is.na(length.1))][order(year, -N)]

wae_gn_records[ ,  , .(lake_id, date_clean , sampling_method, survey_type.1) ]
