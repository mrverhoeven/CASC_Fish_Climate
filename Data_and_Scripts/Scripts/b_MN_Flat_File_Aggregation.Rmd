...
2. add obs id for linking to Halk data
3. Historical WAE survey duplications
4. Make sure all cols match the column names and descriptions thing
5. Make sure only CPUE yes records count towards the totals (see lines 213-225 for those counts from the DNR)
6. Retrieve effort units data (L.273)
7. 
