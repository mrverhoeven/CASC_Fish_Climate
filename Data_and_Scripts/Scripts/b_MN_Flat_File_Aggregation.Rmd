...
indiv_fish <- rbindlist(list(mn_r1_gillnet_indiv_fish_20oct2020,
...
# below is original aged fish files, I think we may still need these..? should check for overlap with region files
