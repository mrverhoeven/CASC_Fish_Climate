...
Drop CPUE from effort
- investigate why DNR CPUE and our calculated CPUE are different
  - MN DNR flag some surveys as not being suitable for CPUE calculations, likely what is causing this difference
  - Kelsey V did work with this when working witht the MN WAE GN data
...
## 7/11/2023 are there two lengths for fish in the MN fish file? If so, how do they differ?
