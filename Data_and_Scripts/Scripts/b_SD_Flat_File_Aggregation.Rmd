...
#exploring null values that are popping up
df_with_null_string <- sd_merged_ce_trial[apply(sd_merged_ce_trial, 1, function(row) any(row == "<Null>")), ]
rm(df_with_null_string)
```
