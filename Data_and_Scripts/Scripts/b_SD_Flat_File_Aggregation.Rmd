...
Here are a few outstanding notes I need before I can finish importing to the broader midwestern database:- units for length are [milimeters]?-units for weights are [grams]?-units for effort are: net-nights or minutes or haul- if I want to count all the WAEcaught in a survey i should sum all from length_weight, aged, and binned, right?- is there any other data in the binned fish (specifically, length/size info would be useful)- one weird binned fish count: 
