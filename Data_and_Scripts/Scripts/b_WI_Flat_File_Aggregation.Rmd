...
# gear_data_notes 1:8 are all electrofishing details
# gear_data_notes 10: depth
melt(wi_inland_effort_19Mar2021,
      id.vars = c("lake_id", "date.1", "sampling_method"),
      measure.vars = c("distance",
                       "gear_data_notes.1", 
                       "gear_data_notes.9", 
                       "sample_time_notes.1", 
                       "sample_time_notes.2"),
      variable.name = "Effort_Type",
      value.name = "Effort")

melt(wi_inland_effort_19Mar2021,
      id.vars = c("lake_id", "date.1", "sampling_method"),
      measure.vars = c( "gear_data_notes.9", 
                       "sample_time_notes.1", 
                       "sample_time_notes.2"),
      variable.name = "Effort_Type",
      value.name = "Effort")

#wi_inland_effort_19Mar2021_Effort <- wi_inland_effort_19Mar2021 %>%mutate(Effort_Value = case_when(str_detect(sampling_method, "net")~ gear_data_notes.1,str_detect(sampling_method, "shock")~ distance))
...
wi_inland_effort_19Mar2021[gear_table, on = "sampling_method"] #### PROBLEM WITH JOIN
