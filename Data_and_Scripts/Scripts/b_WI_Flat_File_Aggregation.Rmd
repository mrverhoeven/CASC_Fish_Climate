...
wi_inland_fishobservations_10Nov2023 %>% 
  filter(year(date) <1938 | year(date) > 2023) %>% 
  distinct(date, flag)
```
...
wi_inland_fishobservations_10Nov2023[ is.na(year), .N , is.na(date) ]
  wi_inland_fishobservations_10Nov2023[ is.na(year) & !str_detect(flag, "bad_date"), year := year(date) ] #this fills year when it is na and date doesn't have a flag
...
wi_inland_fishobservations_10Nov2023[ is.na(year), .N , is.na(date_sample) ]
  ...
  wi_inland_fishobservations_10Nov2023[ is.na(year) & !str_detect(flag, "bad_date"), year := year(date_sample) ]
...
wi_inland_fishobservations_10Nov2023[ is.na(month), .N , is.na(date_sample) ]
  ...
  wi_inland_fishobservations_10Nov2023[ is.na(month) & !str_detect(flag, "bad_date"), month := month(date_sample) ]
...
wi_inland_fishobservations_10Nov2023 %>% 
  distinct(total_effort_ident, year, year_tei = year(date_total_effort_ident)) %>% 
...
wi_inland_fishobservations_10Nov2023 <- wi_inland_fishobservations_10Nov2023 %>% 
  mutate(year = case_when(is.na(year) ~ year(date_total_effort_ident),
                          TRUE ~ year))
...
wi_inland_fishobservations_10Nov2023 <- wi_inland_fishobservations_10Nov2023 %>% 
  mutate(year = case_when(!is.na(total_effort_ident) ~ year(date_total_effort_ident),
                          TRUE ~ year)) 
...
check <- wi_inland_fishobservations_10Nov2023 %>% 
  mutate(year_tei = year(date_total_effort_ident),
         year_survey = year(date_survey)) %>% 
...
wi_inland_fishobservations_10Nov2023 <- wi_inland_fishobservations_10Nov2023 %>% 
  mutate(month = case_when(!is.na(date_total_effort_ident) ~ month(date_total_effort_ident),
                           TRUE ~ month(date_sample)))
```
