...
OUTSTANDING FIXES
DONE  35. Schema matched to overall hive (column names and column inclusions)
DONE  30. Check N species in a survey (is 44 spp a reasonable finding?)


      #flags
DONE  43. Check that our flagging is spelling out implications
DONE  32. Add flags for 0 efforts and high efforts
DONE  44. Auto Flagging: (build a flagging template from the MW Hive then apply it state-by-state)
