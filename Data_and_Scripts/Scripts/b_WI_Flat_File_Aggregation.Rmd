...
wi_inland_lenage_10Nov2023[ year == "218" , date_survey_start ,]
...
wi_inland_lenage_10Nov2023 <- wi_inland_lenage_10Nov2023[ , .(lake_id, date, sampling_method, survey_id, 
                                                              species,
...
merge(wi_inland_fishobservations_10Nov2023,
      ...
      by =  c("lake_id", "date", "sampling_method", "survey_id",
              "species", "length",  "length_unit", "weight", "weight_unit", "sex",
              "age", "aging_structure", 
              "id_indv_win_len"),
      all = T,
