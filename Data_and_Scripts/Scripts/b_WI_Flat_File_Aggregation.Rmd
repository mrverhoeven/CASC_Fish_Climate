...
```{r}
wi_inland_fishobservations_10Nov2023 %>% 
  filter(str_detect(lake_name, "innebag") & date_total_effort_ident == "2014-08-07") %>% 
  distinct(total_effort_ident, sub_effort_ident, site_id, total_effort_1, sub_effort_1_units)
