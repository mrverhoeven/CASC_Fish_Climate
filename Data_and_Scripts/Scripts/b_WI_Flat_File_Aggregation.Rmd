...
```{r}
#effort units
wi_inland_fishobservations_10Nov2023[ , .N , .(total_effort_1_unit, total_effort_2_unit) ]
wi_inland_fishobservations_10Nov2023[is.na(total_effort_1_unit) , .N , is.na(total_effort_2)   ]
wi_inland_fishobservations_10Nov2023[is.na(total_effort_1_unit) & !is.na(total_effort_2_unit) , .N, total_effort_2_unit]
wi_inland_fishobservations_10Nov2023[is.na(total_effort_1_unit) & !is.na(total_effort_2_unit) , .N, original_file_names]
wi_inland_fishobservations_10Nov2023[is.na(total_effort_1_unit) & !is.na(total_effort_2_unit) , .N, .(sampling_method_1, total_effort_2_unit)]
wi_inland_fishobservations_10Nov2023[is.na(total_effort_1_unit) & !is.na(total_effort_2_unit) , ':=' (total_effort_1 = total_effort_2, total_effort_1_unit = total_effort_2_unit, total_effort_2 = NA, total_effort_2_unit = NA)]

wi_inland_fishobservations_10Nov2023[ , .N , .(sampling_method_1 , total_effort_1_unit)][order(sampling_method_1)]
wi_inland_fishobservations_10Nov2023[ , .N , .( total_effort_1_unit)]
#fixing these up
wi_inland_fishobservations_10Nov2023[total_effort_1_unit == "net-nights" , total_effort_1_unit := "net_nights" , ]
wi_inland_fishobservations_10Nov2023[total_effort_1_unit == "number_of_nets", .N , .(sampling_method_1) ]

wi_inland_fishobservations_10Nov2023[total_effort_1_unit == "number_of_nets" & sampling_method_1 %in% c("seine", "seine_smallmesh") , total_effort_1_unit := "hauls" ]
wi_inland_fishobservations_10Nov2023[total_effort_1_unit == "number_of_nets" & sampling_method_1 %in% c("frame_net_miniature" ,"fyke_net", "gill_net_bottom", "gill_net_vertical","gill_net_floating" ) , total_effort_1_unit := "net_nights" ]

for (i in 1:3) {
  col_name <- paste0("sample_time_notes_", i)
  wi_inland_fishobservations_10Nov2023[ str_detect(get(col_name), ":NA"), (col_name) := NA ]
  }
  
  
  wi_inland_fishobservations_10Nov2023[ is.na(total_effort_1) , .N , .(sample_time_notes_1, sample_time_notes_2, sample_time_notes_3, sample_time_units_1, sample_time_units_2, sample_time_units_3, sample_time_min) ]
  setnames(wi_inland_fishobservations_10Nov2023, old = c("sample_time_notes_1", "sample_time_notes_3"), new = c("minutes_sampled", "hours_sampled"))
