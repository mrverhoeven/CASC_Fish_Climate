...
DONE  17. Ensure nothing_caught is assigned at the total_effort_ident level
      ...
      48. Should Cisco data be in the data explainer? They are, but to rerun from that route would nix all our work, so not doing that
...
DONE  10. Flag crazy dates
      ...
      49. TEIs for aged fish that were not matched to fish obs should be assigned TEI == NA
