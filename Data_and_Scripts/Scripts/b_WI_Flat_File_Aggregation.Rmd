...
DONE  17. Ensure nothing_caught is assigned at the total_effort_ident level
      ...
      27. Add weigh to the aged fish join key.
      ...
      29. Check date munging (Look like years are either 4 numbers or 2 numbers (see GH dat sleuthing/ QC probs) )
DONE  10. Flag crazy dates
      ...
      35. Schema matched to overall hive
      36. Review for problems: TEIs sometimes contain multiple water temps straddling the temp cutoffs
      38. There are two target species cols–collapse and comma separate
      39. Do the lengths we have from WI get generated? Do they use a plus bin? (this would be a size of fish that was longer than X) (check for grepex of "+" in the data that are imported)
      ...
      12. Check coverage of NHDids, Lat, Lon
      ...
      46. Collapse targeted sp to one column
          Nix total effort 3 and targeted species 2 
      47. Clean water temp units column. 
