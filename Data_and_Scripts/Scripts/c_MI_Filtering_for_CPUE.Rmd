...
3. Load in inclusion table
     -this has survey characteristics that surveys must have to remain 
4. join the inclusion table based to fish data based on sampling method and survey type for representative cpe
5. filter based on numeric inclusion parameters (effort max and min)
3. join our the fish data to our good surveys so that we collect the fish from those surveys 
