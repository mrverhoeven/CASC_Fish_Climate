...
-dates
-previous filtering included: making survey date the total effort ident date for historical surveys, filtered cpe product so that it did not contain total effort idents with more than one total effort  
