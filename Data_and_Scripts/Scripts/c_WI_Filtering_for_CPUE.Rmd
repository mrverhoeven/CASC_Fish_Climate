...
# Data
```{r}
wi_data <- open_dataset(sources = file.path("D:", "Shared drives", "Hansen Lab", "RESEARCH PROJECTS", "Fish Survey Data", "Parquet files", "hive_update"), partitioning = c("state")) %>% 
...
good_surveys %>% 
  ...
  count()
#multi water temps attribute to most of the duplicate total effort idnets, lets explore more when we get our fish records attached 
