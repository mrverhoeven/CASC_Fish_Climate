...
wi_data %>% 
  ...
  collect()
```
For fyke nets it is really obvious that it is standard to report in hours and we will proceed only using hours for that gear. For electrofishing the most used unit is mintues, we will need to make sure that only minutes show up for electrofishing and only hours for fykes.
