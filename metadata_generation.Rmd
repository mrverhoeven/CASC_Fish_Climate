...
Notes from exploration as of 10/29:
1. state = good
2. county = WI are not capitalized and have _; some NA values from MN and WI
3. lake_name = WI are not capitalized and have _; NA values from WI
4. lake_id =  good; NAs in IA, IN, and SD
5. nhdhr_id = good; some degree of NAs in every state; some lakes have multiple lake ids for one NHDHRID in MN (never the opposite) - no checked in other states
6. latitude_lake_centroid = 6 MN lats that are actually lons, 1 IA value that is 0
7. longitude_lake_cenroid = 6 MN lons that are actually lats, 1 IA value that is 0
8. date_survey = WI has a slew of dates that are not correct (years above 2024 or below 1800); some NAs, NA dates in MI, WI, and IN (not unexpected in WI and IN)
9. date_total_effort_ident = WI has a slew of dates that are not correct; NA dates in MI, WI, and IN (not unexpected in WI and IN)
10. date_sub_effort_ident = WI has a slew of dates that are not correct; NA dates in MI, WI, and IN (not unexpected in WI, IN, MN)
11. date_sample = WI has a slew of dates that are not correct; check what this even is - why is it NA for most samples?
12. year = WI has messed up years; NA years in Indiana and Michigan because NA dates - make sure we retain the year
13. month = NA months = some NAs generated because date is NA and the column was generated from date (IN)
14. survey_id = good
15. survey_type = not standardized across states
16. survey_type_2 = in WI some are NA but 2 and 4 are not 
17. survey_type_3 = 
18. survey_type_4 = in WI some are "" and not just NA
19. sampling_method_simple = good
20. sampling_method = good
21. sampling_method_2 = consider moving some notes to gear_data_notes
22. gear_data_notes = pretty rough standardization wise is it worth cleaning up "NA_NA_NA_NA" type notes?
23. targeted_species = 
24. targeted_species_2 = only used in Wisconsin - combine with target species 1 and drop column?
25. total_effort_ident = good; consider looking at combinations with other columns
26. total_effort_1 = high efforts in WI; negative effort in MN?
27. total_effort_2 = 0 efforts in iowa and Wisconsin; conciser flags for total effort 2 column?
28. total_effort_3 = no state has a total effort 3 - nix this column?
29. total_effort_1_units = clean up MN and WI to match others
30. total_effort_2_units = clean up WI and IA to be standardized; there are some records in IA and WI that only have total effort 2 units - consider moving the to total effort 1
31. total_effort_3_units = no state has total effort 3 units - nix this column?
32. total_effort_nothing_caught = MN appears to be NA instead of FALSE
33. water_temp = WI is the only state that has the data
34. water_temp_units = WI unit needs to be cleaned 
35. 
